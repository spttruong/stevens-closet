<template>
    <div class='outfit-preview'>
        <router-link :to='{ name: "outfit", params: {"id" : outfit.id }}'>
            <div data-test='outfit-title' class='outfit-title'>{{ getOutfitDetails(outfit.id)['title'] }}</div>
        </router-link>
        
        <add-to-favorites-button data-test='favorites-button' :outfitId='outfitId'></add-to-favorites-button>
